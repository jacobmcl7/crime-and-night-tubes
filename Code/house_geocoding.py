...
arcpy.conversion.ExcelToTable(
    Input_Excel_File=r"C:\Users\jpmcl\OneDrive\Documents\Economics\Papers (WIP)\Crime and night tubes EXTRA DATA\house_data_pre_geocoding.xlsx",
...
arcpy.conversion.ExportTable(
    in_table="near_table",
    out_table=r"C:\Users\jpmcl\OneDrive\Documents\Economics\Papers (WIP)\Crime and night tubes EXTRA DATA\house_data_geocoded.csv",
    where_clause="",
...
# need to rerun to get the correctly named file, and need to maybe remove irrelevant fields here rather than in the R cleaning file